let imageEl = document.getElementById('puppyImage')
...
function onClickLikeButton() {
    if (isImageLiked === false) {
        imageEl.src = "https://d1tgh8fmlzexmh.cloudfront.net/ccbp-dynamic-webaps/white-puppy-liked-img.png";
        likeIconElement.style.color = "#0967d2";
        likeButtonElement.style.backgroundColor = "#0967d2";
        likeButtonElement.style.color = "#ffffff";
        isImageLiked = true;
    } else {
        imageEl.src = "https://d1tgh8fmlzexmh.cloudfront.net/ccbp-dynamic-webaps/white-puppy-img.png";
